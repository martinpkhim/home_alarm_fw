...
C_SRCS += \
../app/tasks/gsm_task/gsm_task.c 

OBJS += \
./app/tasks/gsm_task/gsm_task.o 

C_DEPS += \
./app/tasks/gsm_task/gsm_task.d 


# Each subdirectory must supply rules for building sources it contributes
app/tasks/gsm_task/%.o app/tasks/gsm_task/%.su: ../app/tasks/gsm_task/%.c app/tasks/gsm_task/subdir.mk
...
clean: clean-app-2f-tasks-2f-gsm_task

clean-app-2f-tasks-2f-gsm_task:
	-$(RM) ./app/tasks/gsm_task/gsm_task.d ./app/tasks/gsm_task/gsm_task.o ./app/tasks/gsm_task/gsm_task.su

.PHONY: clean-app-2f-tasks-2f-gsm_task
