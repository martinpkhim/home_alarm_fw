...
C_SRCS += \
../app/tasks/lcd_task/lcd_task.c 

OBJS += \
./app/tasks/lcd_task/lcd_task.o 

C_DEPS += \
./app/tasks/lcd_task/lcd_task.d 


# Each subdirectory must supply rules for building sources it contributes
app/tasks/lcd_task/%.o app/tasks/lcd_task/%.su: ../app/tasks/lcd_task/%.c app/tasks/lcd_task/subdir.mk
...
clean: clean-app-2f-tasks-2f-lcd_task

clean-app-2f-tasks-2f-lcd_task:
	-$(RM) ./app/tasks/lcd_task/lcd_task.d ./app/tasks/lcd_task/lcd_task.o ./app/tasks/lcd_task/lcd_task.su

.PHONY: clean-app-2f-tasks-2f-lcd_task
