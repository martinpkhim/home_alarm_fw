...
C_SRCS += \
../app/tasks/io_task/io_task.c 

OBJS += \
./app/tasks/io_task/io_task.o 

C_DEPS += \
./app/tasks/io_task/io_task.d 


# Each subdirectory must supply rules for building sources it contributes
app/tasks/io_task/%.o app/tasks/io_task/%.su: ../app/tasks/io_task/%.c app/tasks/io_task/subdir.mk
...
clean: clean-app-2f-tasks-2f-io_task

clean-app-2f-tasks-2f-io_task:
	-$(RM) ./app/tasks/io_task/io_task.d ./app/tasks/io_task/io_task.o ./app/tasks/io_task/io_task.su

.PHONY: clean-app-2f-tasks-2f-io_task
