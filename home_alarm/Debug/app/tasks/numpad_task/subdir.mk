...
C_DEPS += \
./app/tasks/numpad_task/numpad_task.d 


# Each subdirectory must supply rules for building sources it contributes
app/tasks/numpad_task/%.o app/tasks/numpad_task/%.su: ../app/tasks/numpad_task/%.c app/tasks/numpad_task/subdir.mk
...
clean: clean-app-2f-tasks-2f-numpad_task

clean-app-2f-tasks-2f-numpad_task:
	-$(RM) ./app/tasks/numpad_task/numpad_task.d ./app/tasks/numpad_task/numpad_task.o ./app/tasks/numpad_task/numpad_task.su

.PHONY: clean-app-2f-tasks-2f-numpad_task
