...
C_SRCS += \
../app/tasks/core_tasks/manager_task/manager_task.c 

OBJS += \
./app/tasks/core_tasks/manager_task/manager_task.o 

C_DEPS += \
./app/tasks/core_tasks/manager_task/manager_task.d 


# Each subdirectory must supply rules for building sources it contributes
app/tasks/core_tasks/manager_task/%.o app/tasks/core_tasks/manager_task/%.su: ../app/tasks/core_tasks/manager_task/%.c app/tasks/core_tasks/manager_task/subdir.mk
...
clean: clean-app-2f-tasks-2f-core_tasks-2f-manager_task

clean-app-2f-tasks-2f-core_tasks-2f-manager_task:
	-$(RM) ./app/tasks/core_tasks/manager_task/manager_task.d ./app/tasks/core_tasks/manager_task/manager_task.o ./app/tasks/core_tasks/manager_task/manager_task.su

.PHONY: clean-app-2f-tasks-2f-core_tasks-2f-manager_task
